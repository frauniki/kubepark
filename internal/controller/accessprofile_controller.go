...
// AccessProfileReconciler reconciles a AccessProfile object
...
// the AccessProfile object against the actual cluster state, and then
...
func (r *AccessProfileReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&kubeparkdevv1alpha1.AccessProfile{}).
		Named("accessprofile").
		Complete(r)
}
