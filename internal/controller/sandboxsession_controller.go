...
// SandboxSessionReconciler reconciles a SandboxSession object
...
// the SandboxSession object against the actual cluster state, and then
...
func (r *SandboxSessionReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&kubeparkdevv1alpha1.SandboxSession{}).
